<#ftl encoding="utf-8">
    ...
    <body xmlns="http://www.w3.org/1999/html">
        ...
        <main>
            <form action="/ressources/immeubles/delete" method="post" id="form">
                <div class="important-information-block">
                    <label>Identifiant de l'immeuble à supprimer<input name="idImmeuble" type="text" placeholder="ex: 00254123"></label>
                </div>

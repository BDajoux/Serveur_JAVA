<#ftl encoding="utf-8">
    ...
    <body xmlns="http://www.w3.org/1999/html">
        ...
        <main>
            <form action="/ressources/syndicat/delete" method="post" id="form">
                <div class="important-information-block">
                    <label>Identifiant du syndicat à supprimer<input name="idSyndicat" type="text" placeholder="ex: 00254123"></label>
                </div>
